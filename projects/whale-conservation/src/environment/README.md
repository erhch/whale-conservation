...
**查询参数:**
- `startDate` - 开始时间 (ISO 8601 格式，必填)
- `endDate` - 结束时间 (ISO 8601 格式，必填)
- `limit` - 返回数量上限，默认 100，最大 1000 (可选)
...
| 趋势分析 | `GET /environment/station/:id/range` | 按时间范围查询，分析环境参数变化 |
...
*版本：1.1.0 | 最后更新：2026-03-29 21:15*
